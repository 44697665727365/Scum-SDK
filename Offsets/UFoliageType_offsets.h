namespace offsets
{
	namespace UFoliageType
	{
			...
			constexpr auto Scaling = 0x4c; // Size: 1, Type: uint8_t 
			...
			constexpr auto VertexColorMask = 0x98; // Size: 1, Type: char FoliageVertexColorMask
			...
			constexpr auto Mobility = 0x13c; // Size: 1, Type: char EComponentMobility
			...
			constexpr auto LightmapType = 0x150; // Size: 1, Type: uint8_t 
			...
			constexpr auto CustomNavigableGeometry = 0x2b8; // Size: 1, Type: char EHasCustomNavigableGeometry
			...
			constexpr auto CustomDepthStencilWriteMask = 0x2c0; // Size: 1, Type: uint8_t 
			...
			constexpr auto CollisionRadius = 0x2cc; // Size: 4, Type: float
			constexpr auto ShadeRadius = 0x2d0; // Size: 4, Type: float
			constexpr auto NumSteps = 0x2d4; // Size: 4, Type: int32_t
			constexpr auto InitialSeedDensity = 0x2d8; // Size: 4, Type: float
			constexpr auto AverageSpreadDistance = 0x2dc; // Size: 4, Type: float
			constexpr auto SpreadVariance = 0x2e0; // Size: 4, Type: float
			constexpr auto SeedsPerStep = 0x2e4; // Size: 4, Type: int32_t
			constexpr auto DistributionSeed = 0x2e8; // Size: 4, Type: int32_t
			constexpr auto MaxInitialSeedOffset = 0x2ec; // Size: 4, Type: float
			constexpr auto bCanGrowInShade = 0x2f0; // Size: 1, Type: bool
			constexpr auto bSpawnsInShade = 0x2f1; // Size: 1, Type: bool
			constexpr auto MaxInitialAge = 0x2f4; // Size: 4, Type: float
			constexpr auto MaxAge = 0x2f8; // Size: 4, Type: float
			constexpr auto OverlapPriority = 0x2fc; // Size: 4, Type: float
			constexpr auto ProceduralScale = 0x300; // Size: 8, Type: struct FFloatInterval
			constexpr auto ScaleCurve = 0x308; // Size: 136, Type: struct FRuntimeFloatCurve
			constexpr auto ChangeCount = 0x390; // Size: 4, Type: int32_t
			constexpr auto ReapplyDensity = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyRadius = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyAlignToNormal = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyRandomYaw = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyScaling = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyScaleX = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyScaleY = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyScaleZ = 0x394; // Size: 1, Type: char
			constexpr auto ReapplyRandomPitchAngle = 0x395; // Size: 1, Type: char
			constexpr auto ReapplyGroundSlope = 0x395; // Size: 1, Type: char
			constexpr auto ReapplyHeight = 0x395; // Size: 1, Type: char
			constexpr auto ReapplyLandscapeLayers = 0x395; // Size: 1, Type: char
			constexpr auto ReapplyZOffset = 0x395; // Size: 1, Type: char
			constexpr auto ReapplyCollisionWithWorld = 0x395; // Size: 1, Type: char
			constexpr auto ReapplyVertexColorMask = 0x395; // Size: 1, Type: char
			constexpr auto bEnableDensityScaling = 0x395; // Size: 1, Type: char
			constexpr auto bEnableDiscardOnLoad = 0x396; // Size: 1, Type: char
			constexpr auto RuntimeVirtualTextures = 0x398; // Size: 16, Type: struct TArray<struct URuntimeVirtualTexture*>
			constexpr auto VirtualTextureCullMips = 0x3a8; // Size: 4, Type: int32_t
			constexpr auto VirtualTextureRenderPassType = 0x3ac; // Size: 1, Type: uint8_t 
	}
} 
