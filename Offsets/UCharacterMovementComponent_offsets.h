namespace offsets
{
	namespace UCharacterMovementComponent
	{
			...
			constexpr auto MovementMode = 0x168; // Size: 1, Type: char EMovementMode
			constexpr auto CustomMovementMode = 0x169; // Size: 1, Type: char
			constexpr auto NetworkSmoothingMode = 0x16a; // Size: 1, Type: uint8_t 
			...
			constexpr auto DefaultLandMovementMode = 0x384; // Size: 1, Type: char EMovementMode
			constexpr auto DefaultWaterMovementMode = 0x385; // Size: 1, Type: char EMovementMode
			constexpr auto GroundMovementMode = 0x386; // Size: 1, Type: char EMovementMode
