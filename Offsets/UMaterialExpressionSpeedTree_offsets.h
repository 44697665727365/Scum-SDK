namespace offsets
{
	namespace UMaterialExpressionSpeedTree
	{
			...
			constexpr auto GeometryType = 0x90; // Size: 1, Type: char ESpeedTreeGeometryType
			constexpr auto WindType = 0x91; // Size: 1, Type: char ESpeedTreeWindType
			constexpr auto LODType = 0x92; // Size: 1, Type: char ESpeedTreeLODType
