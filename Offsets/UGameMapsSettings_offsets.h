namespace offsets
{
	namespace UGameMapsSettings
	{
			...
			constexpr auto TwoPlayerSplitscreenLayout = 0x51; // Size: 1, Type: char ETwoPlayerSplitScreenType
			constexpr auto ThreePlayerSplitscreenLayout = 0x52; // Size: 1, Type: char EThreePlayerSplitScreenType
			constexpr auto FourPlayerSplitscreenLayout = 0x53; // Size: 1, Type: uint8_t 
