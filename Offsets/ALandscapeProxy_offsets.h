namespace offsets
{
	namespace ALandscapeProxy
	{
			...
			constexpr auto LODFalloff = 0x248; // Size: 1, Type: char ELandscapeLODFalloff
			...
			constexpr auto VirtualTextureRenderPassType = 0x2e0; // Size: 1, Type: uint8_t 
			...
			constexpr auto CustomDepthStencilWriteMask = 0x3a4; // Size: 1, Type: uint8_t 
			constexpr auto CustomDepthStencilValue = 0x3a8; // Size: 4, Type: int32_t
			constexpr auto LDMaxDrawDistance = 0x3ac; // Size: 4, Type: float
			constexpr auto LightmassSettings = 0x3b0; // Size: 24, Type: struct FLightmassPrimitiveSettings
			constexpr auto CollisionMipLevel = 0x3c8; // Size: 4, Type: int32_t
			constexpr auto SimpleCollisionMipLevel = 0x3cc; // Size: 4, Type: int32_t
			constexpr auto CollisionThickness = 0x3d0; // Size: 4, Type: float
			...
			constexpr auto NavigationGeometryGatheringMode = 0x545; // Size: 1, Type: uint8_t 
