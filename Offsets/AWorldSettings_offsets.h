namespace offsets
{
	namespace AWorldSettings
	{
			...
			constexpr auto VisibilityAggressiveness = 0x22c; // Size: 1, Type: char EVisibilityAggressiveness
			...
			constexpr auto DefaultColorScale = 0x27c; // Size: 12, Type: struct FVector
			constexpr auto DefaultMaxDistanceFieldOcclusionDistance = 0x288; // Size: 4, Type: float
			constexpr auto GlobalDistanceFieldViewDistance = 0x28c; // Size: 4, Type: float
			constexpr auto DynamicIndirectShadowsSelfShadowingIntensity = 0x290; // Size: 4, Type: float
			...
			constexpr auto BroadphaseSettings = 0x304; // Size: 36, Type: struct FBroadphaseSettings
			constexpr auto Pauser = 0x328; // Size: 8, Type: struct APlayerState*
			constexpr auto ReplicationViewers = 0x330; // Size: 16, Type: struct TArray<struct FNetViewer>
			constexpr auto AssetUserData = 0x340; // Size: 16, Type: struct TArray<struct UAssetUserData*>
			constexpr auto PauserPlayerState = 0x350; // Size: 8, Type: struct APlayerState*
			constexpr auto MaxNumberOfBookmarks = 0x358; // Size: 4, Type: int32_t
			constexpr auto DefaultBookmarkClass = 0x360; // Size: 8, Type: UBookmarkBase*
			constexpr auto BookmarkArray = 0x368; // Size: 16, Type: struct TArray<struct UBookmarkBase*>
			constexpr auto LastBookmarkClass = 0x378; // Size: 8, Type: UBookmarkBase*
	}
} 
