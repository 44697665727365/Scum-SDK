namespace offsets
{
	namespace UNiagaraDataInterfaceChaosDestruction
	{
			...
			constexpr auto DataSourceType = 0x88; // Size: 1, Type: uint8_t 
			...
			constexpr auto LocationFilteringMode = 0xe0; // Size: 1, Type: uint8_t 
			constexpr auto LocationXToSpawn = 0xe1; // Size: 1, Type: uint8_t 
			constexpr auto LocationXToSpawnMinMax = 0xe4; // Size: 8, Type: struct FVector2D
			constexpr auto LocationYToSpawn = 0xec; // Size: 1, Type: uint8_t 
			constexpr auto LocationYToSpawnMinMax = 0xf0; // Size: 8, Type: struct FVector2D
			constexpr auto LocationZToSpawn = 0xf8; // Size: 1, Type: uint8_t 
			constexpr auto LocationZToSpawnMinMax = 0xfc; // Size: 8, Type: struct FVector2D
			constexpr auto DataSortingType = 0x104; // Size: 1, Type: uint8_t 
			...
			constexpr auto RandomVelocityGenerationType = 0x198; // Size: 1, Type: uint8_t 
			...
			constexpr auto DebugType = 0x1cc; // Size: 1, Type: uint8_t 
