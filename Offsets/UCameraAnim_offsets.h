namespace offsets
{
	namespace UCameraAnim
	{
			...
			constexpr auto BasePostProcessSettings = 0x60; // Size: 1376, Type: struct FPostProcessSettings
			constexpr auto BasePostProcessBlendWeight = 0x5c0; // Size: 4, Type: float
	}
} 
