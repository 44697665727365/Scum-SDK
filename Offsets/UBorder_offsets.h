namespace offsets
{
	namespace UBorder
	{
			constexpr auto HorizontalAlignment = 0x120; // Size: 1, Type: char EHorizontalAlignment
			constexpr auto VerticalAlignment = 0x121; // Size: 1, Type: char EVerticalAlignment
