namespace offsets
{
	...
	{
			constexpr auto RenderFocusRule = 0x38; // Size: 1, Type: uint8_t 
			constexpr auto HardwareCursors = 0x40; // Size: 80, Type: struct TMap<char EMouseCursor, struct FHardwareCursorReference>
			constexpr auto SoftwareCursors = 0x90; // Size: 80, Type: struct TMap<char EMouseCursor, struct FSoftClassPath>
			...
			constexpr auto UIScaleRule = 0x18c; // Size: 1, Type: uint8_t 
