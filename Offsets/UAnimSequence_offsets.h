namespace offsets
{
	namespace UAnimSequence
	{
			...
			constexpr auto AdditiveAnimType = 0x150; // Size: 1, Type: char EAdditiveAnimationType
			constexpr auto RefPoseType = 0x151; // Size: 1, Type: char EAdditiveBasePoseType
			...
			constexpr auto Interpolation = 0x180; // Size: 1, Type: uint8_t 
			constexpr auto bEnableRootMotion = 0x181; // Size: 1, Type: bool
			constexpr auto RootMotionRootLock = 0x182; // Size: 1, Type: char ERootMotionRootLock
