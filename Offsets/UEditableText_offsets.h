namespace offsets
{
	namespace UEditableText
	{
			...
			constexpr auto KeyboardType = 0x426; // Size: 1, Type: char EVirtualKeyboardType
			constexpr auto VirtualKeyboardOptions = 0x427; // Size: 1, Type: struct FVirtualKeyboardOptions
			constexpr auto VirtualKeyboardTrigger = 0x428; // Size: 1, Type: uint8_t 
			constexpr auto VirtualKeyboardDismissAction = 0x429; // Size: 1, Type: uint8_t 
			constexpr auto Justification = 0x42a; // Size: 1, Type: char ETextJustify
