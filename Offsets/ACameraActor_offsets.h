namespace offsets
{
	...
	{
			constexpr auto AutoActivateForPlayer = 0x220; // Size: 1, Type: char EAutoReceiveInput
			...
			constexpr auto PostProcessSettings = 0x250; // Size: 1376, Type: struct FPostProcessSettings
	}
} 
