namespace offsets
{
	...
	{
			constexpr auto SourceMethod = 0x30; // Size: 1, Type: char Beam2SourceTargetMethod
			...
			constexpr auto SourceTangentMethod = 0x8c; // Size: 1, Type: char Beam2SourceTargetTangentMethod
