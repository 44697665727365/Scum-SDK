namespace offsets
{
	namespace UStaticMeshSimulationComponent
	{
			...
			constexpr auto ObjectType = 0xba; // Size: 1, Type: uint8_t 
			constexpr auto Mass = 0xbc; // Size: 4, Type: float
			constexpr auto CollisionType = 0xc0; // Size: 1, Type: uint8_t 
			constexpr auto ImplicitType = 0xc1; // Size: 1, Type: uint8_t 
			...
			constexpr auto InitialVelocityType = 0xcc; // Size: 1, Type: uint8_t 
