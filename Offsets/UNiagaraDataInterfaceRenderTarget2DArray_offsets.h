namespace offsets
{
	namespace UNiagaraDataInterfaceRenderTarget2DArray
	{
			constexpr auto Size = 0xd8; // Size: 12, Type: struct FIntVector
			constexpr auto OverrideRenderTargetFormat = 0xe4; // Size: 1, Type: char ETextureRenderTargetFormat
			...
			constexpr auto ManagedRenderTargets = 0x108; // Size: 80, Type: struct TMap<uint64_t, struct UTextureRenderTarget2DArray*>
	}
} 
