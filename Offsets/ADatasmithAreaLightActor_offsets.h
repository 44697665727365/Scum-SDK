namespace offsets
{
	...
	{
			constexpr auto Mobility = 0x220; // Size: 1, Type: char EComponentMobility
			constexpr auto LightType = 0x221; // Size: 1, Type: uint8_t 
			constexpr auto LightShape = 0x222; // Size: 1, Type: uint8_t 
			constexpr auto Dimensions = 0x224; // Size: 8, Type: struct FVector2D
			constexpr auto Intensity = 0x22c; // Size: 4, Type: float
			constexpr auto IntensityUnits = 0x230; // Size: 1, Type: uint8_t 
