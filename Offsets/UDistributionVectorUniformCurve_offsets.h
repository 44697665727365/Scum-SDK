namespace offsets
{
	namespace UDistributionVectorUniformCurve
	{
			...
			constexpr auto LockedAxes[2] = 0x54; // Size: 2, Type: char EDistributionVectorLockFlags
			constexpr auto MirrorFlags[3] = 0x56; // Size: 3, Type: char EDistributionVectorMirrorFlags
