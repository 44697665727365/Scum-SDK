namespace offsets
{
	namespace UBackgroundBlur
	{
			...
			constexpr auto HorizontalAlignment = 0x130; // Size: 1, Type: char EHorizontalAlignment
			constexpr auto VerticalAlignment = 0x131; // Size: 1, Type: char EVerticalAlignment
