namespace offsets
{
	namespace UCheckBox
	{
			constexpr auto CheckedState = 0x120; // Size: 1, Type: uint8_t 
			...
			constexpr auto HorizontalAlignment = 0x708; // Size: 1, Type: char EHorizontalAlignment
			...
			constexpr auto ClickMethod = 0x748; // Size: 1, Type: char EButtonClickMethod
			constexpr auto TouchMethod = 0x749; // Size: 1, Type: char EButtonTouchMethod
			constexpr auto PressMethod = 0x74a; // Size: 1, Type: char EButtonPressMethod
