namespace offsets
{
	namespace UARSessionConfig
	{
			...
			constexpr auto WorldAlignment = 0x3a; // Size: 1, Type: uint8_t 
			constexpr auto SessionType = 0x3b; // Size: 1, Type: uint8_t 
			constexpr auto PlaneDetectionMode = 0x3c; // Size: 1, Type: uint8_t 
			...
			constexpr auto LightEstimationMode = 0x40; // Size: 1, Type: uint8_t 
			constexpr auto FrameSyncMode = 0x41; // Size: 1, Type: uint8_t 
			...
			constexpr auto EnvironmentCaptureProbeType = 0x5c; // Size: 1, Type: uint8_t 
			...
			constexpr auto FaceTrackingDirection = 0x8d; // Size: 1, Type: uint8_t 
			constexpr auto FaceTrackingUpdate = 0x8e; // Size: 1, Type: uint8_t 
			...
			constexpr auto EnabledSessionTrackingFeature = 0xa8; // Size: 1, Type: uint8_t 
			constexpr auto SceneReconstructionMethod = 0xa9; // Size: 1, Type: uint8_t 
