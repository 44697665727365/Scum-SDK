namespace offsets
{
	namespace URevolveProperties
	{
			...
			constexpr auto PolygroupMode = 0x77; // Size: 1, Type: uint8_t 
			constexpr auto QuadSplitMode = 0x78; // Size: 1, Type: uint8_t 
			constexpr auto DiagonalProportionTolerance = 0x80; // Size: 8, Type: double
			constexpr auto CapFillMode = 0x88; // Size: 1, Type: uint8_t 
