namespace offsets
{
	namespace UParticleSystem
	{
			...
			constexpr auto SystemUpdateMode = 0xb2; // Size: 1, Type: char EParticleSystemUpdateMode
			constexpr auto LODMethod = 0xb3; // Size: 1, Type: char ParticleSystemLODMethod
			constexpr auto InsignificantReaction = 0xb4; // Size: 1, Type: uint8_t 
			constexpr auto OcclusionBoundsMethod = 0xb5; // Size: 1, Type: char EParticleSystemOcclusionBoundsMethod
			constexpr auto MaxSignificanceLevel = 0xb7; // Size: 1, Type: uint8_t 
