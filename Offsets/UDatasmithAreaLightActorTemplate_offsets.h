namespace offsets
{
	...
	{
			constexpr auto LightType = 0x30; // Size: 1, Type: uint8_t 
			constexpr auto LightShape = 0x31; // Size: 1, Type: uint8_t 
			...
			constexpr auto IntensityUnits = 0x50; // Size: 1, Type: uint8_t 
