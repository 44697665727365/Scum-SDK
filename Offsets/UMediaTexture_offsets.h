namespace offsets
{
	...
	{
			constexpr auto AddressX = 0x178; // Size: 1, Type: char TextureAddress
			constexpr auto AddressY = 0x179; // Size: 1, Type: char TextureAddress
			...
			constexpr auto OutputFormat = 0x18f; // Size: 1, Type: char MediaTextureOutputFormat
			constexpr auto CurrentAspectRatio = 0x190; // Size: 4, Type: float
			constexpr auto CurrentOrientation = 0x194; // Size: 1, Type: char MediaTextureOrientation
