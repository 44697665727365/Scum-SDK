namespace offsets
{
	namespace UParticleModuleCollision
	{
			...
			constexpr auto CollisionCompletionOption = 0xf0; // Size: 1, Type: char EParticleCollisionComplete
			constexpr auto CollisionTypes = 0xf8; // Size: 16, Type: struct TArray<char EObjectTypeQuery>
