namespace offsets
{
	namespace UGeometryCollection
	{
			...
			constexpr auto ClusterConnectionType = 0x50; // Size: 1, Type: uint8_t 
			...
			constexpr auto CollisionType = 0x78; // Size: 1, Type: uint8_t 
			constexpr auto ImplicitType = 0x79; // Size: 1, Type: uint8_t 
