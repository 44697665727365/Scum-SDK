namespace offsets
{
	namespace UNiagaraMeshRendererProperties
	{
			...
			constexpr auto SourceMode = 0x88; // Size: 1, Type: uint8_t 
			constexpr auto SortMode = 0x89; // Size: 1, Type: uint8_t 
			...
			constexpr auto PivotOffsetSpace = 0x894; // Size: 1, Type: uint8_t 
	}
} 
