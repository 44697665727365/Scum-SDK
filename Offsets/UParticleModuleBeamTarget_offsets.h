namespace offsets
{
	...
	{
			constexpr auto TargetMethod = 0x30; // Size: 1, Type: char Beam2SourceTargetMethod
			...
			constexpr auto TargetTangentMethod = 0x8c; // Size: 1, Type: char Beam2SourceTargetTangentMethod
