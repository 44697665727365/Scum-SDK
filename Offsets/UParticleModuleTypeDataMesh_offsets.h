namespace offsets
{
	namespace UParticleModuleTypeDataMesh
	{
			...
			constexpr auto MeshAlignment = 0x45; // Size: 1, Type: char EMeshScreenAlignment
			...
			constexpr auto AxisLockOption = 0x90; // Size: 1, Type: char EParticleAxisLock
			constexpr auto bCameraFacing = 0x91; // Size: 1, Type: char
			constexpr auto CameraFacingUpAxisOption = 0x92; // Size: 1, Type: char EMeshCameraFacingUpAxis
			constexpr auto CameraFacingOption = 0x93; // Size: 1, Type: char EMeshCameraFacingOptions
