namespace offsets
{
	namespace UPhysicalMaterial
	{
			...
			constexpr auto FrictionCombineMode = 0x30; // Size: 1, Type: char EFrictionCombineMode
			constexpr auto bOverrideFrictionCombineMode = 0x31; // Size: 1, Type: bool
			constexpr auto Restitution = 0x34; // Size: 4, Type: float
			constexpr auto RestitutionCombineMode = 0x38; // Size: 1, Type: char EFrictionCombineMode
			...
			constexpr auto SurfaceType = 0x60; // Size: 1, Type: char EPhysicalSurface
	}
} 
