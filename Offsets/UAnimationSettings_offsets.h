namespace offsets
{
	namespace UAnimationSettings
	{
			...
			constexpr auto AttributeBlendModes = 0x78; // Size: 80, Type: struct TMap<struct FName, uint8_t >
			constexpr auto DefaultAttributeBlendMode = 0xc8; // Size: 1, Type: uint8_t 
	}
} 
