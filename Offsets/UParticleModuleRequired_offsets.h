namespace offsets
{
	namespace UParticleModuleRequired
	{
			...
			constexpr auto ScreenAlignment = 0x58; // Size: 1, Type: char EParticleScreenAlignment
			...
			constexpr auto SortMode = 0x5a; // Size: 1, Type: char EParticleSortMode
			...
			constexpr auto InterpolationMethod = 0xa9; // Size: 1, Type: char EParticleSubUVInterpMethod
			constexpr auto bScaleUV = 0xaa; // Size: 1, Type: char
			constexpr auto bEmitterDelayUseRange = 0xaa; // Size: 1, Type: char
			constexpr auto ParticleBurstMethod = 0xab; // Size: 1, Type: char EParticleBurstMethod
			constexpr auto bOverrideSystemMacroUV = 0xac; // Size: 1, Type: char
			constexpr auto bUseMaxDrawCount = 0xac; // Size: 1, Type: char
			constexpr auto OpacitySourceMode = 0xad; // Size: 1, Type: char EOpacitySourceMode
			constexpr auto EmitterNormalsMode = 0xae; // Size: 1, Type: char EEmitterNormalsMode
			...
			constexpr auto UVFlippingMode = 0xd0; // Size: 1, Type: uint8_t 
			constexpr auto BoundingMode = 0xd1; // Size: 1, Type: char ESubUVBoundingVertexCount
