namespace offsets
{
	namespace UNiagaraRibbonRendererProperties
	{
			...
			constexpr auto FacingMode = 0xa0; // Size: 1, Type: uint8_t 
			...
			constexpr auto DrawDirection = 0xec; // Size: 1, Type: uint8_t 
			constexpr auto Shape = 0xed; // Size: 1, Type: uint8_t 
			...
			constexpr auto TessellationMode = 0x114; // Size: 1, Type: uint8_t 
