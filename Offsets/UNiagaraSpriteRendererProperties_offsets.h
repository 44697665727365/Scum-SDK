namespace offsets
{
	namespace UNiagaraSpriteRendererProperties
	{
			...
			constexpr auto SourceMode = 0x80; // Size: 1, Type: uint8_t 
			constexpr auto MaterialUserParamBinding = 0x88; // Size: 32, Type: struct FNiagaraUserParameterBinding
			constexpr auto Alignment = 0xa8; // Size: 1, Type: uint8_t 
			constexpr auto FacingMode = 0xa9; // Size: 1, Type: uint8_t 
			constexpr auto PivotInUVSpace = 0xac; // Size: 8, Type: struct FVector2D
			constexpr auto SortMode = 0xb4; // Size: 1, Type: uint8_t 
