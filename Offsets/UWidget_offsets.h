namespace offsets
{
	namespace UWidget
	{
			...
			constexpr auto Cursor = 0xc1; // Size: 1, Type: char EMouseCursor
			constexpr auto Clipping = 0xc2; // Size: 1, Type: uint8_t 
			constexpr auto Visibility = 0xc3; // Size: 1, Type: uint8_t 
			constexpr auto RenderOpacity = 0xc4; // Size: 4, Type: float
			constexpr auto Navigation = 0xc8; // Size: 8, Type: struct UWidgetNavigation*
			constexpr auto FlowDirectionPreference = 0xd0; // Size: 1, Type: uint8_t 
