namespace offsets
{
	namespace USoundWave
	{
			...
			constexpr auto SampleRateQuality = 0x178; // Size: 1, Type: uint8_t 
			constexpr auto SoundGroup = 0x17a; // Size: 1, Type: char ESoundGroup
			...
			constexpr auto LoadingBehavior = 0x17c; // Size: 1, Type: uint8_t 
