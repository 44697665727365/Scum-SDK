namespace offsets
{
	namespace UButton
	{
			...
			constexpr auto ClickMethod = 0x3c0; // Size: 1, Type: char EButtonClickMethod
			constexpr auto TouchMethod = 0x3c1; // Size: 1, Type: char EButtonTouchMethod
			constexpr auto PressMethod = 0x3c2; // Size: 1, Type: char EButtonPressMethod
