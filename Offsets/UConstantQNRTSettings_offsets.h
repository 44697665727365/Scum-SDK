namespace offsets
{
	namespace UConstantQNRTSettings
	{
			...
			constexpr auto FFTSize = 0x39; // Size: 1, Type: uint8_t 
			constexpr auto WindowType = 0x3a; // Size: 1, Type: uint8_t 
			constexpr auto SpectrumType = 0x3b; // Size: 1, Type: uint8_t 
			constexpr auto BandWidthStretch = 0x3c; // Size: 4, Type: float
			constexpr auto CQTNormalization = 0x40; // Size: 1, Type: uint8_t 
