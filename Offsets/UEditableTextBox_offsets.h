namespace offsets
{
	namespace UEditableTextBox
	{
			...
			constexpr auto KeyboardType = 0x9fe; // Size: 1, Type: char EVirtualKeyboardType
			constexpr auto VirtualKeyboardOptions = 0x9ff; // Size: 1, Type: struct FVirtualKeyboardOptions
			constexpr auto VirtualKeyboardTrigger = 0xa00; // Size: 1, Type: uint8_t 
			constexpr auto VirtualKeyboardDismissAction = 0xa01; // Size: 1, Type: uint8_t 
			constexpr auto Justification = 0xa02; // Size: 1, Type: char ETextJustify
