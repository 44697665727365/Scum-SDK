namespace offsets
{
	namespace UEnvQueryTest
	{
			...
			constexpr auto TestPurpose = 0x34; // Size: 1, Type: char EEnvTestPurpose
			constexpr auto TestComment = 0x38; // Size: 16, Type: struct FString
			constexpr auto MultipleContextFilterOp = 0x48; // Size: 1, Type: char EEnvTestFilterOperator
			constexpr auto MultipleContextScoreOp = 0x49; // Size: 1, Type: char EEnvTestScoreOperator
			constexpr auto FilterType = 0x4a; // Size: 1, Type: char EEnvTestFilterType
			...
			constexpr auto ScoringEquation = 0xf9; // Size: 1, Type: char EEnvTestScoreEquation
			constexpr auto ClampMinType = 0xfa; // Size: 1, Type: char EEnvQueryTestClamping
			constexpr auto ClampMaxType = 0xfb; // Size: 1, Type: char EEnvQueryTestClamping
			constexpr auto NormalizationType = 0xfc; // Size: 1, Type: uint8_t 
