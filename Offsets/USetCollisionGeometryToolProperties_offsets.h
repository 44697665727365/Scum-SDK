namespace offsets
{
	...
	{
			constexpr auto GeometryType = 0x60; // Size: 4, Type: uint8_t 
			constexpr auto InputMode = 0x64; // Size: 4, Type: uint8_t 
			...
			constexpr auto SweepAxis = 0x84; // Size: 4, Type: uint8_t 
			constexpr auto bAppendToExisting = 0x88; // Size: 1, Type: bool
			constexpr auto SetCollisionType = 0x8c; // Size: 4, Type: uint8_t 
	}
} 
