namespace offsets
{
	namespace UNavigationSystemV1
	{
			...
			constexpr auto DataGatheringMode = 0x70; // Size: 1, Type: uint8_t 
			...
			constexpr auto OperationMode = 0x1fc; // Size: 1, Type: uint8_t 
			constexpr auto DirtyAreasUpdateFreq = 0x15fc; // Size: 4, Type: float
	}
} 
