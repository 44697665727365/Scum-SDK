namespace offsets
{
	namespace UPaperTileMap
	{
			...
			constexpr auto SpriteCollisionDomain = 0x8c; // Size: 1, Type: char ESpriteCollisionMode
			constexpr auto ProjectionMode = 0x8d; // Size: 1, Type: char ETileMapProjectionMode
