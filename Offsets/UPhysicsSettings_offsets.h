namespace offsets
{
	namespace UPhysicsSettings
	{
			...
			constexpr auto LockedAxis = 0x114; // Size: 1, Type: char ESettingsLockedAxis
			constexpr auto DefaultDegreesOfFreedom = 0x115; // Size: 1, Type: char ESettingsDOF
			...
			constexpr auto DefaultBroadphaseSettings = 0x158; // Size: 36, Type: struct FBroadphaseSettings
			constexpr auto MinDeltaVelocityForHitEvents = 0x17c; // Size: 4, Type: float
			constexpr auto ChaosSettings = 0x180; // Size: 3, Type: struct FChaosPhysicsSettings
	}
} 
