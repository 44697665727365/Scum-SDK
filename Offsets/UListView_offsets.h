namespace offsets
{
	namespace UListView
	{
			constexpr auto Orientation = 0x2d8; // Size: 1, Type: char EOrientation
			constexpr auto SelectionMode = 0x2d9; // Size: 1, Type: char ESelectionMode
			constexpr auto ConsumeMouseWheel = 0x2da; // Size: 1, Type: uint8_t 
