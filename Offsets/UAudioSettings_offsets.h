namespace offsets
{
	namespace UAudioSettings
	{
			...
			constexpr auto VoiPSampleRate = 0x110; // Size: 4, Type: uint8_t 
			...
			constexpr auto PanningMethod = 0x140; // Size: 1, Type: uint8_t 
			constexpr auto MonoChannelUpmixMethod = 0x141; // Size: 1, Type: uint8_t 
