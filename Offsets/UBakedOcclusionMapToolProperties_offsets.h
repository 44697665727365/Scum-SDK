namespace offsets
{
	...
	{
			constexpr auto Preview = 0x60; // Size: 4, Type: uint8_t 
			...
			constexpr auto Distribution = 0x70; // Size: 4, Type: uint8_t 
			...
			constexpr auto NormalSpace = 0x80; // Size: 4, Type: uint8_t 
	}
} 
