namespace offsets
{
	namespace UARTrackedGeometry
	{
			...
			constexpr auto TrackingState = 0xa0; // Size: 1, Type: uint8_t 
			constexpr auto UnderlyingMesh = 0xb0; // Size: 8, Type: struct UMRMeshComponent*
			constexpr auto ObjectClassification = 0xb8; // Size: 1, Type: uint8_t 
			constexpr auto SpatialMeshUsageFlags = 0xb9; // Size: 1, Type: uint8_t 
