namespace offsets
{
	...
	{
			constexpr auto EntryBoxType = 0x108; // Size: 1, Type: uint8_t 
			...
			constexpr auto EntryHorizontalAlignment = 0x130; // Size: 1, Type: char EHorizontalAlignment
			constexpr auto EntryVerticalAlignment = 0x131; // Size: 1, Type: char EVerticalAlignment
