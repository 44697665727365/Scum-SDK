namespace offsets
{
	...
	{
			constexpr auto SourceType = 0x30; // Size: 1, Type: char ELocationBoneSocketSource
			...
			constexpr auto SelectionMethod = 0x50; // Size: 1, Type: char ELocationBoneSocketSelectionMethod
