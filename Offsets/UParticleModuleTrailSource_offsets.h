namespace offsets
{
	...
	{
			constexpr auto SourceMethod = 0x30; // Size: 1, Type: char ETrail2SourceMethod
			...
			constexpr auto SelectionMethod = 0x88; // Size: 1, Type: char EParticleSourceSelectionMethod
