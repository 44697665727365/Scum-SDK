namespace offsets
{
	namespace UAnimCompress_PerTrackCompression
	{
			...
			constexpr auto AllowedRotationFormats = 0x70; // Size: 16, Type: struct TArray<char AnimationCompressionFormat>
			constexpr auto AllowedTranslationFormats = 0x80; // Size: 16, Type: struct TArray<char AnimationCompressionFormat>
			constexpr auto AllowedScaleFormats = 0x90; // Size: 16, Type: struct TArray<char AnimationCompressionFormat>
