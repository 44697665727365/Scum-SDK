namespace offsets
{
	namespace UPhysicsSettingsCore
	{
			...
			constexpr auto FrictionCombineMode = 0x5c; // Size: 1, Type: char EFrictionCombineMode
			constexpr auto RestitutionCombineMode = 0x5d; // Size: 1, Type: char EFrictionCombineMode
			...
			constexpr auto DefaultShapeComplexity = 0x75; // Size: 1, Type: char ECollisionTraceFlag
