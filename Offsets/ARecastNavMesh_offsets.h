namespace offsets
{
	namespace ARecastNavMesh
	{
			...
			constexpr auto RegionPartitioning = 0x48c; // Size: 1, Type: char ERecastPartitioning
			constexpr auto LayerPartitioning = 0x48d; // Size: 1, Type: char ERecastPartitioning
