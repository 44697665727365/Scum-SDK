namespace offsets
{
	namespace UMaterialExpressionRuntimeVirtualTextureSample
	{
			...
			constexpr auto MaterialType = 0x88; // Size: 1, Type: uint8_t 
			constexpr auto bSinglePhysicalSpace = 0x89; // Size: 1, Type: bool
			constexpr auto bAdaptive = 0x8a; // Size: 1, Type: bool
			constexpr auto MipValueMode = 0x8b; // Size: 1, Type: char ERuntimeVirtualTextureMipValueMode
			constexpr auto TextureAddressMode = 0x8c; // Size: 1, Type: char ERuntimeVirtualTextureTextureAddressMode
	}
} 
