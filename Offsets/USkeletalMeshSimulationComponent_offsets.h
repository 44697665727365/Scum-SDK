namespace offsets
{
	namespace USkeletalMeshSimulationComponent
	{
			...
			constexpr auto ObjectType = 0xd2; // Size: 1, Type: uint8_t 
			...
			constexpr auto CollisionType = 0xe0; // Size: 1, Type: uint8_t 
			...
			constexpr auto InitialVelocityType = 0xfc; // Size: 1, Type: uint8_t 
