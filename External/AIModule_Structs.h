...
public:
	...
	char EPathFollowingResult GetResult() {
		return memory.read<char EPathFollowingResult>(m_addr + 4);
	}
...
public:
	...
	char EBTDecoratorLogic GetOperation() {
		return memory.read<char EBTDecoratorLogic>(m_addr + 0);
	}
	uint16_t GetNumber() {
...
public:
	...
	char EPathFollowingResult GetMovementResult() {
		return memory.read<char EPathFollowingResult>(m_addr + 0);
	}
...
public:
	...
	char EEnvQueryStatus GetQueryStatus() {
		return memory.read<char EEnvQueryStatus>(m_addr + 8);
	}
...
public:
	...
	char EEnvQueryRunMode GetRunMode() {
		return memory.read<char EEnvQueryRunMode>(m_addr + 64);
	}
...
public:
	...
	char EAIRequestPriority GetPriority() {
		return memory.read<char EAIRequestPriority>(m_addr + 16);
	}
	bool GetReturnValue() {
...
public:
	...
	char EPawnActionResult GetWithResult() {
		return memory.read<char EPawnActionResult>(m_addr + 0);
	}
...
public:
	...
	char ECollisionChannel GetOverlapChannel() {
		return memory.read<char ECollisionChannel>(m_addr + 24);
	}
	char EEnvOverlapShape GetOverlapShape() {
		return memory.read<char EEnvOverlapShape>(m_addr + 25);
	}
...
public:
	...
	char ETraceTypeQuery GetTraceChannel() {
		return memory.read<char ETraceTypeQuery>(m_addr + 40);
	}
	char ECollisionChannel GetSerializedChannel() {
		return memory.read<char ECollisionChannel>(m_addr + 41);
	}
	char EEnvTraceShape GetTraceShape() {
		return memory.read<char EEnvTraceShape>(m_addr + 42);
	}
	char EEnvQueryTrace GetTraceMode() {
		return memory.read<char EEnvQueryTrace>(m_addr + 43);
	}
...
public:
	...
	char EEnvDirection GetDirMode() {
		return memory.read<char EEnvDirection>(m_addr + 24);
	}
...
public:
	...
	char EPathFollowingStatus GetReturnValue() {
		return memory.read<char EPathFollowingStatus>(m_addr + 0);
	}
...
public:
	...
	char EPathFollowingAction GetReturnValue() {
		return memory.read<char EPathFollowingAction>(m_addr + 0);
	}
...
public:
	...
	char EPathFollowingRequestResult GetReturnValue() {
		return memory.read<char EPathFollowingRequestResult>(m_addr + 25);
	}
...
public:
	...
	char EPathFollowingRequestResult GetReturnValue() {
		return memory.read<char EPathFollowingRequestResult>(m_addr + 33);
	}
...
public:
	...
	char EEndPlayReason GetEndPlayReason() {
		return memory.read<char EEndPlayReason>(m_addr + 8);
	}
...
public:
	...
	char EAIOptionFlag GetStopOnOverlap() {
		return memory.read<char EAIOptionFlag>(m_addr + 36);
	}
	char EAIOptionFlag GetAcceptPartialPath() {
		return memory.read<char EAIOptionFlag>(m_addr + 37);
	}
	bool GetbUsePathfinding() {
	...
	char EAIOptionFlag GetProjectGoalOnNavigation() {
		return memory.read<char EAIOptionFlag>(m_addr + 41);
	}
...
public:
	...
	char EPawnActionAbortState GetReturnValue() {
		return memory.read<char EPawnActionAbortState>(m_addr + 8);
	}
...
public:
	...
	char EBTNodeResult GetNodeResult() {
		return memory.read<char EBTNodeResult>(m_addr + 16);
	}
...
public:
	...
	char EBTNodeResult GetNodeResult() {
		return memory.read<char EBTNodeResult>(m_addr + 8);
	}
...
public:
	...
	char EEnvQueryRunMode GetRunMode() {
		return memory.read<char EEnvQueryRunMode>(m_addr + 24);
	}
...
public:
	...
	char EAIRequestPriority GetReturnValue() {
		return memory.read<char EAIRequestPriority>(m_addr + 0);
	}
...
public:
	...
	char EPawnActionResult GetWithResult() {
		return memory.read<char EPawnActionResult>(m_addr + 8);
	}
...
public:
	...
	char EAIRequestPriority GetPriority() {
		return memory.read<char EAIRequestPriority>(m_addr + 8);
	}
