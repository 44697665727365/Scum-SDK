...
public:
	...
	char EFlipbookCollisionMode GetCollisionSource() {
		return memory.read<char EFlipbookCollisionMode>(m_addr + 72);
	}
...
public:
	...
	struct TArray<struct FSpriteInstanceData> GetPerInstanceSpriteData() {
		return memory.read<struct TArray<struct FSpriteInstanceData>>(m_addr + 1160);
	}
...
public:
	...
	char GetbLooping() {
		return memory.read<char>(m_addr + 1164);
	}
	...
	struct FLinearColor GetSpriteColor() {
		return memory.read<struct FLinearColor>(m_addr + 1176);
	}
	...
	struct FMulticastInlineDelegate GetOnFinishedPlaying() {
		return memory.read<struct FMulticastInlineDelegate>(m_addr + 1200);
	}
...
public:
	...
	char ESpriteCollisionMode GetSpriteCollisionDomain() {
		return memory.read<char ESpriteCollisionMode>(m_addr + 128);
	}
...
public:
	...
	char ESpriteCollisionMode GetSpriteCollisionDomain() {
		return memory.read<char ESpriteCollisionMode>(m_addr + 1156);
	}
...
public:
	...
	char ESpriteCollisionMode GetSpriteCollisionDomain() {
		return memory.read<char ESpriteCollisionMode>(m_addr + 140);
	}
	char ETileMapProjectionMode GetProjectionMode() {
		return memory.read<char ETileMapProjectionMode>(m_addr + 141);
	}
...
public:
	...
	struct FLinearColor GetTileMapColor() {
		return memory.read<struct FLinearColor>(m_addr + 1192);
	}
