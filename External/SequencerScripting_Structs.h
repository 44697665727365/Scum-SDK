...
public:
	...
	char ERichCurveInterpMode GetInNewValue() {
		return memory.read<char ERichCurveInterpMode>(m_addr + 0);
	}
...
public:
	...
	char ERichCurveInterpMode GetReturnValue() {
		return memory.read<char ERichCurveInterpMode>(m_addr + 0);
	}
...
public:
	...
	char ERichCurveTangentMode GetInNewValue() {
		return memory.read<char ERichCurveTangentMode>(m_addr + 0);
	}
...
public:
	...
	char ERichCurveTangentMode GetReturnValue() {
		return memory.read<char ERichCurveTangentMode>(m_addr + 0);
	}
...
public:
	...
	char ERichCurveTangentWeightMode GetReturnValue() {
		return memory.read<char ERichCurveTangentWeightMode>(m_addr + 0);
	}
...
public:
	...
	char ERichCurveTangentWeightMode GetInNewValue() {
		return memory.read<char ERichCurveTangentWeightMode>(m_addr + 0);
	}
...
public:
	...
	char ERichCurveExtrapolation GetReturnValue() {
...
public:
	...
	char ERichCurveExtrapolation GetInExtrapolation() {
		return memory.read<char ERichCurveExtrapolation>(m_addr + 0);
	}
