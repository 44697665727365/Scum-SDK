...
public:
	...
	char ETwoPlayerSplitScreenType GetTwoPlayerSplitscreenLayout() {
		return memory.read<char ETwoPlayerSplitScreenType>(m_addr + 81);
	}
	char EThreePlayerSplitScreenType GetThreePlayerSplitscreenLayout() {
		return memory.read<char EThreePlayerSplitScreenType>(m_addr + 82);
	}
	uint8_t  GetFourPlayerSplitscreenLayout() {
		return memory.read<uint8_t >(m_addr + 83);
	}
