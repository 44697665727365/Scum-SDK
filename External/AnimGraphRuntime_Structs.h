...
public:
	...
	char EAxis GetFootBoneForwardAxis() {
		return memory.read<char EAxis>(m_addr + 40);
	}
	char EAxis GetHingeRotationAxis() {
		return memory.read<char EAxis>(m_addr + 41);
	}
...
public:
	...
	uint8_t  GetDriveSource() {
		return memory.read<uint8_t >(m_addr + 300);
	}
	uint8_t  GetDriveOutput() {
		return memory.read<uint8_t >(m_addr + 301);
	}
...
public:
	...
	uint8_t  GetAlphaInputType() {
		return memory.read<uint8_t >(m_addr + 196);
	}
	bool GetbAlphaBoolEnabled() {
...
public:
	...
	char ERefPoseType GetRefPoseType() {
		return memory.read<char ERefPoseType>(m_addr + 16);
	}
...
public:
	...
	uint8_t  GetSimulationSpace() {
		return memory.read<uint8_t >(m_addr + 577);
	}
...
public:
	...
	char EBoneControlSpace GetDisplaySpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 216);
	}
...
public:
	...
	char EBoneControlSpace GetTransformsSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 96);
	}
...
public:
	...
	uint8_t  GetLinearXLimitType() {
		return memory.read<uint8_t >(m_addr + 0);
	}
	uint8_t  GetLinearYLimitType() {
		return memory.read<uint8_t >(m_addr + 1);
	}
	uint8_t  GetLinearZLimitType() {
	...
	uint8_t  GetAngularConstraintType() {
		return memory.read<uint8_t >(m_addr + 28);
	}
	uint8_t  GetTwistAxis() {
		return memory.read<uint8_t >(m_addr + 29);
	}
	uint8_t  GetAngularTargetAxis() {
		return memory.read<uint8_t >(m_addr + 30);
	}
	float GetConeAngle() {
...
public:
	...
	uint8_t  GetDestinationMode() {
		return memory.read<uint8_t >(m_addr + 268);
	}
	uint8_t  GetModificationMode() {
		return memory.read<uint8_t >(m_addr + 269);
	}
	char EComponentType GetSourceComponent() {
		return memory.read<char EComponentType>(m_addr + 270);
	}
	char GetbUseRange() {
...
public:
	...
	char EBoneControlSpace GetEffectorLocationSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 212);
	}
...
public:
	...
	char EBoneAxis GetRotationAxisToRefer() {
		return memory.read<char EBoneAxis>(m_addr + 236);
	}
	bool GetbIsAdditive() {
...
public:
	...
	uint8_t  GetOffsetOption() {
		return memory.read<uint8_t >(m_addr + 16);
	}
	uint8_t  GetTransformType() {
...
public:
	...
	char EBoneControlSpace GetControlSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 235);
	}
...
public:
	...
	char EBoneControlSpace GetEffectorTransformSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 392);
	}
	char EBoneRotationSource GetEffectorRotationSource() {
		return memory.read<char EBoneRotationSource>(m_addr + 393);
	}
...
public:
	...
	char ECurveBlendOption GetCurveBlendOption() {
		return memory.read<char ECurveBlendOption>(m_addr + 82);
	}
...
public:
	...
	char EInterpolationBlend GetInterpolationType() {
		return memory.read<char EInterpolationBlend>(m_addr + 349);
	}
...
public:
	...
	char EBoneModificationMode GetTranslationMode() {
		return memory.read<char EBoneModificationMode>(m_addr + 252);
	}
	char EBoneModificationMode GetRotationMode() {
		return memory.read<char EBoneModificationMode>(m_addr + 253);
	}
	char EBoneModificationMode GetScaleMode() {
		return memory.read<char EBoneModificationMode>(m_addr + 254);
	}
	char EBoneControlSpace GetTranslationSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 255);
	}
	char EBoneControlSpace GetRotationSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 256);
	}
	char EBoneControlSpace GetScaleSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 257);
	}
...
public:
	...
	uint8_t  GetFunction() {
		return memory.read<uint8_t >(m_addr + 13);
	}
	uint8_t  GetDistanceMethod() {
		return memory.read<uint8_t >(m_addr + 14);
	}
	char EBoneAxis GetTwistAxis() {
		return memory.read<char EBoneAxis>(m_addr + 15);
	}
	float GetWeightThreshold() {
		return memory.read<float>(m_addr + 16);
	}
	uint8_t  GetNormalizeMethod() {
...
public:
	...
	char ECollisionChannel GetOverlapChannel() {
		return memory.read<char ECollisionChannel>(m_addr + 504);
	}
	uint8_t  GetSimulationSpace() {
...
public:
	...
	char ESequenceEvalReinit GetReinitializationBehavior() {
		return memory.read<char ESequenceEvalReinit>(m_addr + 70);
	}
	float GetStartPosition() {
...
public:
	...
	char EAxis GetChainBoneAxis() {
		return memory.read<char EAxis>(m_addr + 276);
	}
...
public:
	...
	char EBoneControlSpace GetEffectorLocationSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 464);
	}
	char EBoneControlSpace GetJointTargetLocationSpace() {
		return memory.read<char EBoneControlSpace>(m_addr + 465);
	}
...
public:
	...
	uint8_t  GetFunctionType() {
		return memory.read<uint8_t >(m_addr + 153);
	}
...
public:
	...
	char ERelativeTransformSpace GetSocketSpace() {
		return memory.read<char ERelativeTransformSpace>(m_addr + 32);
	}
	...
	uint8_t  GetEasingType() {
		return memory.read<uint8_t >(m_addr + 108);
	}
	struct FRuntimeFloatCurve GetCustomCurve() {
...
public:
	...
	char ERelativeTransformSpace GetSocketSpaceA() {
		return memory.read<char ERelativeTransformSpace>(m_addr + 16);
	}
	struct FName GetSocketOrBoneNameB() {
		return memory.read<struct FName>(m_addr + 20);
	}
	char ERelativeTransformSpace GetSocketSpaceB() {
		return memory.read<char ERelativeTransformSpace>(m_addr + 28);
	}
	bool GetbRemapRange() {
