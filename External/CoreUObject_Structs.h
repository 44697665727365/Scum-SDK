...
public:
	...
	char ERangeBoundTypes GetType() {
		return memory.read<char ERangeBoundTypes>(m_addr + 0);
	}
...
public:
	...
	char EInterpCurveMode GetInterpMode() {
		return memory.read<char EInterpCurveMode>(m_addr + 76);
	}
...
public:
	...
	char EInterpCurveMode GetInterpMode() {
		return memory.read<char EInterpCurveMode>(m_addr + 16);
	}
...
public:
	...
	char EInterpCurveMode GetInterpMode() {
		return memory.read<char EInterpCurveMode>(m_addr + 28);
	}
...
public:
	...
	char EInterpCurveMode GetInterpMode() {
		return memory.read<char EInterpCurveMode>(m_addr + 40);
	}
...
public:
	...
	char EInterpCurveMode GetInterpMode() {
		return memory.read<char EInterpCurveMode>(m_addr + 64);
	}
...
public:
	...
	char EInterpCurveMode GetInterpMode() {
		return memory.read<char EInterpCurveMode>(m_addr + 52);
	}
