...
public:
	...
	char ERichCurveExtrapolation GetPreInfinityExtrap() {
		return memory.read<char ERichCurveExtrapolation>(m_addr + 8);
	}
	char ERichCurveExtrapolation GetPostInfinityExtrap() {
		return memory.read<char ERichCurveExtrapolation>(m_addr + 9);
	}
	struct TArray<struct FFrameNumber> GetTimes() {
...
public:
	...
	char ERichCurveInterpMode GetInterpMode() {
		return memory.read<char ERichCurveInterpMode>(m_addr + 24);
	}
	char ERichCurveTangentMode GetTangentMode() {
		return memory.read<char ERichCurveTangentMode>(m_addr + 25);
	}
	char GetPaddingByte() {
...
public:
	...
	char ERichCurveTangentWeightMode GetTangentWeightMode() {
		return memory.read<char ERichCurveTangentWeightMode>(m_addr + 16);
	}
...
public:
	...
	uint8_t  GetEvaluationMethod() {
		return memory.read<uint8_t >(m_addr + 18);
	}
...
public:
	...
	char EMovieScenePlayerStatus GetLastKnownStatus() {
		return memory.read<char EMovieScenePlayerStatus>(m_addr + 8);
	}
