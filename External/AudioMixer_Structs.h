...
public:
	...
	uint8_t  GetInterpolationMethod() {
...
public:
	...
	uint8_t  GetInStartingMusicalNote() {
...
public:
	...
	uint8_t  GetInQuantizationBoundary() {
		return memory.read<uint8_t >(m_addr + 8);
	}
	struct FDelegate GetOnQuantizationEvent() {
