...
public:
	...
	char ETextJustify GetJustification() {
		return memory.read<char ETextJustify>(m_addr + 267);
	}
	uint8_t  GetWrappingPolicy() {
...
public:
	...
	uint8_t  GetTextTransformPolicy() {
		return memory.read<uint8_t >(m_addr + 980);
	}
...
public:
	...
	char EMouseCursor GetCursor() {
		return memory.read<char EMouseCursor>(m_addr + 193);
	}
	uint8_t  GetClipping() {
		return memory.read<uint8_t >(m_addr + 194);
	}
	uint8_t  GetVisibility() {
		return memory.read<uint8_t >(m_addr + 195);
	}
	...
	uint8_t  GetFlowDirectionPreference() {
...
public:
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 72);
	}
	char EVerticalAlignment GetVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 73);
	}
	int32_t Getrow() {
...
public:
	...
	uint8_t  GetTextTransformPolicy() {
		return memory.read<uint8_t >(m_addr + 662);
	}
...
public:
	...
	char EButtonClickMethod GetClickMethod() {
		return memory.read<char EButtonClickMethod>(m_addr + 960);
	}
	char EButtonTouchMethod GetTouchMethod() {
		return memory.read<char EButtonTouchMethod>(m_addr + 961);
	}
	char EButtonPressMethod GetPressMethod() {
		return memory.read<char EButtonPressMethod>(m_addr + 962);
	}
	bool GetIsFocusable() {
...
public:
	...
	uint8_t  GetVirtualKeyboardDismissAction() {
		return memory.read<uint8_t >(m_addr + 1086);
	}
...
public:
	...
	char EOrientation GetOrientation() {
		return memory.read<char EOrientation>(m_addr + 306);
	}
...
public:
	...
	char EVirtualKeyboardType GetKeyboardType() {
		return memory.read<char EVirtualKeyboardType>(m_addr + 2558);
	}
	struct FVirtualKeyboardOptions GetVirtualKeyboardOptions() {
		return memory.read<struct FVirtualKeyboardOptions>(m_addr + 2559);
	}
	uint8_t  GetVirtualKeyboardTrigger() {
		return memory.read<uint8_t >(m_addr + 2560);
	}
	uint8_t  GetVirtualKeyboardDismissAction() {
		return memory.read<uint8_t >(m_addr + 2561);
	}
	char ETextJustify GetJustification() {
		return memory.read<char ETextJustify>(m_addr + 2562);
	}
	struct FShapedTextOptions GetShapedTextOptions() {
...
public:
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 304);
	}
	char EVerticalAlignment GetVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 305);
	}
...
public:
	...
	char EHorizontalAlignment GetEntryHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 304);
	}
	char EVerticalAlignment GetEntryVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 305);
	}
...
public:
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 288);
	}
	char EVerticalAlignment GetVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 289);
	}
...
public:
	...
	char EOrientation GetOrientation() {
		return memory.read<char EOrientation>(m_addr + 1506);
	}
...
public:
	...
	uint8_t  GetCheckedState() {
		return memory.read<uint8_t >(m_addr + 288);
	}
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 1800);
	}
	struct FMargin GetPadding() {
	...
	char EButtonClickMethod GetClickMethod() {
		return memory.read<char EButtonClickMethod>(m_addr + 1864);
	}
	char EButtonTouchMethod GetTouchMethod() {
		return memory.read<char EButtonTouchMethod>(m_addr + 1865);
	}
	char EButtonPressMethod GetPressMethod() {
		return memory.read<char EButtonPressMethod>(m_addr + 1866);
	}
	bool GetIsFocusable() {
...
public:
	...
	char EVirtualKeyboardType GetKeyboardType() {
		return memory.read<char EVirtualKeyboardType>(m_addr + 1062);
	}
	struct FVirtualKeyboardOptions GetVirtualKeyboardOptions() {
	...
	uint8_t  GetVirtualKeyboardDismissAction() {
		return memory.read<uint8_t >(m_addr + 1065);
	}
	char ETextJustify GetJustification() {
		return memory.read<char ETextJustify>(m_addr + 1066);
	}
	struct FShapedTextOptions GetShapedTextOptions() {
...
public:
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 80);
	}
	char EVerticalAlignment GetVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 81);
	}
...
public:
	...
	char EOrientation GetOrientation() {
		return memory.read<char EOrientation>(m_addr + 728);
	}
	char ESelectionMode GetSelectionMode() {
		return memory.read<char ESelectionMode>(m_addr + 729);
	}
	uint8_t  GetConsumeMouseWheel() {
		return memory.read<uint8_t >(m_addr + 730);
	}
...
public:
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 88);
	}
	char EVerticalAlignment GetVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 89);
	}
...
public:
	...
	char EMenuPlacement GetPlacement() {
		return memory.read<char EMenuPlacement>(m_addr + 328);
	}
...
public:
	...
	uint8_t  GetVirtualKeyboardDismissAction() {
		return memory.read<uint8_t >(m_addr + 3027);
	}
	struct USlateWidgetStyleAsset GetStyle() {
...
public:
	...
	char EProgressBarFillType GetBarFillType() {
		return memory.read<char EProgressBarFillType>(m_addr + 716);
	}
	bool GetbIsMarquee() {
...
public:
	...
	char EHorizontalAlignment GetHAlign() {
		return memory.read<char EHorizontalAlignment>(m_addr + 76);
	}
	char EVerticalAlignment GetVAlign() {
		return memory.read<char EVerticalAlignment>(m_addr + 77);
	}
	struct FMargin GetPadding() {
...
public:
	...
	char EStretch GetStretch() {
		return memory.read<char EStretch>(m_addr + 288);
	}
	char EStretchDirection GetStretchDirection() {
		return memory.read<char EStretchDirection>(m_addr + 289);
	}
...
public:
	...
	char EOrientation GetOrientation() {
		return memory.read<char EOrientation>(m_addr + 2088);
	}
	uint8_t  GetScrollBarVisibility() {
		return memory.read<uint8_t >(m_addr + 2089);
	}
	uint8_t  GetConsumeMouseWheel() {
		return memory.read<uint8_t >(m_addr + 2090);
	}
	...
	uint8_t  GetNavigationDestination() {
		return memory.read<uint8_t >(m_addr + 2120);
	}
	float GetNavigationScrollPadding() {
		return memory.read<float>(m_addr + 2124);
	}
	uint8_t  GetScrollWhenFocusChanges() {
		return memory.read<uint8_t >(m_addr + 2128);
	}
...
public:
	...
	uint8_t  GetAccessibleBehavior() {
		return memory.read<uint8_t >(m_addr + 41);
	}
	uint8_t  GetAccessibleSummaryBehavior() {
...
public:
	...
	char EOrientation GetOrientation() {
		return memory.read<char EOrientation>(m_addr + 1128);
	}
...
public:
	...
	char ETextJustify GetJustification() {
		return memory.read<char ETextJustify>(m_addr + 1152);
	}
	float GetMinDesiredWidth() {
...
public:
	...
	char EHorizontalAlignment GetHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 56);
	}
	char EVerticalAlignment GetVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 57);
	}
	int32_t Getrow() {
...
public:
	...
	uint8_t  GetSpace() {
		return memory.read<uint8_t >(m_addr + 1144);
	}
	uint8_t  GetTimingPolicy() {
		return memory.read<uint8_t >(m_addr + 1145);
	}
	...
	struct FIntPoint GetDrawSize() {
		return memory.read<struct FIntPoint>(m_addr + 1160);
	}
	...
	struct FIntPoint GetCurrentDrawSize() {
		return memory.read<struct FIntPoint>(m_addr + 1184);
	}
	bool GetbDrawAtDesiredSize() {
		return memory.read<bool>(m_addr + 1192);
	}
	struct FVector2D GetPivot() {
		return memory.read<struct FVector2D>(m_addr + 1196);
	}
	bool GetbReceiveHardwareInput() {
		return memory.read<bool>(m_addr + 1204);
	}
	bool GetbWindowFocusable() {
		return memory.read<bool>(m_addr + 1205);
	}
	uint8_t  GetWindowVisibility() {
		return memory.read<uint8_t >(m_addr + 1206);
	}
	bool GetbApplyGammaCorrection() {
		return memory.read<bool>(m_addr + 1207);
	}
	...
	struct FLinearColor GetBackgroundColor() {
		return memory.read<struct FLinearColor>(m_addr + 1216);
	}
	struct FLinearColor GetTintColorAndOpacity() {
		return memory.read<struct FLinearColor>(m_addr + 1232);
	}
	float GetOpacityFromTexture() {
		return memory.read<float>(m_addr + 1248);
	}
	uint8_t  GetBlendMode() {
		return memory.read<uint8_t >(m_addr + 1252);
	}
	bool GetbIsTwoSided() {
		return memory.read<bool>(m_addr + 1253);
	}
	bool GetTickWhenOffscreen() {
		return memory.read<bool>(m_addr + 1254);
	}
	...
	struct FName GetSharedLayerName() {
		return memory.read<struct FName>(m_addr + 1332);
	}
	int32_t GetLayerZOrder() {
		return memory.read<int32_t>(m_addr + 1340);
	}
	uint8_t  GetGeometryMode() {
		return memory.read<uint8_t >(m_addr + 1344);
	}
	float GetCylinderArcAngle() {
		return memory.read<float>(m_addr + 1348);
	}
	uint8_t  GetTickMode() {
		return memory.read<uint8_t >(m_addr + 1352);
	}
...
public:
	...
	uint8_t  GetInteractionSource() {
		return memory.read<uint8_t >(m_addr + 552);
	}
	...
	struct FHitResult GetCustomHitResult() {
		return memory.read<struct FHitResult>(m_addr + 704);
	}
	...
	struct FVector2D GetLastLocalHitLocation() {
		return memory.read<struct FVector2D>(m_addr + 848);
	}
