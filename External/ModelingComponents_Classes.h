...
public:
	...
	uint8_t  GetTangentsType() {
		return memory.read<uint8_t >(m_addr + 1216);
	}
...
public:
	...
	struct FBoxSphereBounds GetBounds() {
		return memory.read<struct FBoxSphereBounds>(m_addr + 1144);
	}
	bool GetbBoundsDirty() {
