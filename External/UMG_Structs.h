...
public:
	...
	char ESelectionMode GetSelectionMode() {
		return memory.read<char ESelectionMode>(m_addr + 0);
	}
...
public:
	...
	char EMouseCursor GetInCursor() {
		return memory.read<char EMouseCursor>(m_addr + 0);
	}
...
public:
	...
	char EMouseCursor GetReturnValue() {
		return memory.read<char EMouseCursor>(m_addr + 0);
	}
...
public:
	...
	char EStretch GetInStretch() {
		return memory.read<char EStretch>(m_addr + 0);
	}
...
public:
	...
	char EMouseCursor GetCursorShape() {
		return memory.read<char EMouseCursor>(m_addr + 8);
	}
...
public:
	...
	char EUMGSequencePlayMode GetPlayMode() {
		return memory.read<char EUMGSequencePlayMode>(m_addr + 36);
	}
...
public:
	...
	char ETextJustify GetInJustification() {
		return memory.read<char ETextJustify>(m_addr + 0);
	}
...
public:
	...
	uint8_t  GetTextShapingMethod() {
		return memory.read<uint8_t >(m_addr + 1);
	}
	uint8_t  GetTextFlowDirection() {
...
public:
	...
	char EInputEvent GetEventType() {
		return memory.read<char EInputEvent>(m_addr + 8);
	}
...
public:
	...
	char EHorizontalAlignment GetInHorizontalAlignment() {
		return memory.read<char EHorizontalAlignment>(m_addr + 0);
	}
...
public:
	...
	char EMenuPlacement GetInPlacement() {
		return memory.read<char EMenuPlacement>(m_addr + 0);
	}
...
public:
	...
	char EUMGSequencePlayMode GetPlayMode() {
		return memory.read<char EUMGSequencePlayMode>(m_addr + 16);
	}
	float GetPlaybackSpeed() {
...
public:
	...
	char EUMGSequencePlayMode GetPlayMode() {
		return memory.read<char EUMGSequencePlayMode>(m_addr + 20);
	}
	float GetPlaybackSpeed() {
		return memory.read<float>(m_addr + 24);
	}
...
public:
	...
	char ESlateSizeRule GetSizeRule() {
		return memory.read<char ESlateSizeRule>(m_addr + 4);
	}
...
private:
	std::uint64_t m_addr = 0;
};class FGetViewFraction
{
public:
	FGetViewFraction(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
...
public:
	...
	char EButtonClickMethod GetInClickMethod() {
		return memory.read<char EButtonClickMethod>(m_addr + 0);
	}
...
public:
	...
	char EButtonPressMethod GetInPressMethod() {
		return memory.read<char EButtonPressMethod>(m_addr + 0);
	}
...
public:
	...
	char EButtonTouchMethod GetInTouchMethod() {
		return memory.read<char EButtonTouchMethod>(m_addr + 0);
	}
...
public:
	...
	uint8_t  GetNewConsumeMouseWheel() {
		return memory.read<uint8_t >(m_addr + 0);
	}
...
public:
	...
	char EVerticalAlignment GetInVerticalAlignment() {
		return memory.read<char EVerticalAlignment>(m_addr + 0);
	}
...
public:
	...
	uint8_t  GetNewScrollBarVisibility() {
		return memory.read<uint8_t >(m_addr + 0);
	}
...
public:
	...
	char EStretchDirection GetInStretchDirection() {
		return memory.read<char EStretchDirection>(m_addr + 0);
	}
...
public:
	...
	char EOrientation GetNewOrientation() {
		return memory.read<char EOrientation>(m_addr + 0);
	}
...
public:
	...
	uint8_t  GetNewScrollWhenFocusChanges() {
		return memory.read<uint8_t >(m_addr + 0);
	}
...
public:
	...
	char EUMGSequencePlayMode GetPlayMode() {
		return memory.read<char EUMGSequencePlayMode>(m_addr + 32);
	}
	float GetPlaybackSpeed() {
