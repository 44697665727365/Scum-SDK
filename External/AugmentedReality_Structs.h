...
public:
	...
	uint8_t  GetJointTransformSpace() {
...
public:
	...
	uint8_t  GetSessionTrackingFeature() {
		return memory.read<uint8_t >(m_addr + 1);
	}
	bool GetReturnValue() {
		return memory.read<bool>(m_addr + 2);
...
public:
	...
	struct TMap<uint8_t , struct FLinearColor> GetReturnValue() {
		return memory.read<struct TMap<uint8_t , struct FLinearColor>>(m_addr + 0);
	}
...
public:
	...
	struct TMap<uint8_t , struct FLinearColor> GetInColors() {
		return memory.read<struct TMap<uint8_t , struct FLinearColor>>(m_addr + 0);
	}
...
public:
	...
	uint8_t  GetOutPermissionResult() {
...
public:
	...
	uint8_t  GetInSessionTrackingFeature() {
		return memory.read<uint8_t >(m_addr + 0);
	}
...
public:
	...
	uint8_t  GetInSceneReconstructionMethod() {
		return memory.read<uint8_t >(m_addr + 0);
	}
...
public:
	...
	struct TMap<uint8_t , float> GetReturnValue() {
		return memory.read<struct TMap<uint8_t , float>>(m_addr + 0);
	}
