...
public:
	...
	char ENavPathEvent GetPathEvent() {
		return memory.read<char ENavPathEvent>(m_addr + 8);
	}
...
public:
	...
	char ERecastPartitioning GetRegionPartitioning() {
		return memory.read<char ERecastPartitioning>(m_addr + 48);
	}
	char ERecastPartitioning GetLayerPartitioning() {
		return memory.read<char ERecastPartitioning>(m_addr + 49);
	}
...
public:
	...
	char ENavigationOptionFlag GetDoRecalculation() {
		return memory.read<char ENavigationOptionFlag>(m_addr + 0);
	}
...
public:
	...
	char ENavigationQueryResult GetReturnValue() {
		return memory.read<char ENavigationQueryResult>(m_addr + 56);
	}
