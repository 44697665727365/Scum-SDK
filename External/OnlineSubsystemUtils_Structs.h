...
public:
	...
	char ESpectatorReservationResult GetReservationResponse() {
		return memory.read<char ESpectatorReservationResult>(m_addr + 0);
	}
...
public:
	...
	char EInAppPurchaseState GetPurchaseStatus() {
		return memory.read<char EInAppPurchaseState>(m_addr + 0);
	}
...
public:
	...
	char EInAppPurchaseState GetCompletionStatus() {
		return memory.read<char EInAppPurchaseState>(m_addr + 0);
	}
...
public:
	...
	char EMPMatchOutcome GetLocalPlayerOutcome() {
		return memory.read<char EMPMatchOutcome>(m_addr + 48);
	}
	char EMPMatchOutcome GetOtherPlayersOutcome() {
		return memory.read<char EMPMatchOutcome>(m_addr + 49);
	}
...
public:
	...
	char EMPMatchOutcome GetOutcome() {
		return memory.read<char EMPMatchOutcome>(m_addr + 32);
	}
