...
public:
	...
	char EFieldPhysicsType GetTarget() {
		return memory.read<char EFieldPhysicsType>(m_addr + 1);
	}
...
public:
	...
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 32);
	}
...
public:
	...
	char EFieldResolutionType GetResolutionType() {
		return memory.read<char EFieldResolutionType>(m_addr + 0);
	}
...
public:
	...
	char EFieldFilterType GetFilterType() {
		return memory.read<char EFieldFilterType>(m_addr + 0);
	}
...
public:
	...
	char EFieldOperationType GetOperation() {
		return memory.read<char EFieldOperationType>(m_addr + 24);
	}
...
public:
	...
	char ESetMaskConditionType GetSetMaskConditionIn() {
		return memory.read<char ESetMaskConditionType>(m_addr + 24);
	}
...
public:
	...
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 64);
	}
...
public:
	...
	char EWaveFunctionType GetFunction() {
		return memory.read<char EWaveFunctionType>(m_addr + 28);
	}
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 29);
	}
...
public:
	...
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 44);
	}
...
public:
	...
	char EFieldCullingOperationType GetOperation() {
		return memory.read<char EFieldCullingOperationType>(m_addr + 16);
	}
