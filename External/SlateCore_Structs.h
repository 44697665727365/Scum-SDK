...
public:
	...
	char ESlateColorStylingMode GetColorUseRule() {
		return memory.read<char ESlateColorStylingMode>(m_addr + 16);
	}
...
public:
	...
	char ESlateBrushDrawType GetDrawAs() {
		return memory.read<char ESlateBrushDrawType>(m_addr + 108);
	}
	char ESlateBrushTileType GetTiling() {
		return memory.read<char ESlateBrushTileType>(m_addr + 109);
	}
	char ESlateBrushMirrorType GetMirroring() {
		return memory.read<char ESlateBrushMirrorType>(m_addr + 110);
	}
	char ESlateBrushImageType GetImageType() {
		return memory.read<char ESlateBrushImageType>(m_addr + 111);
	}
...
public:
	...
	char ESlateCheckBoxType GetCheckBoxType() {
		return memory.read<char ESlateCheckBoxType>(m_addr + 8);
	}
