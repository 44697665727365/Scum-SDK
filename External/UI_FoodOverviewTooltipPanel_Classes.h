...
class UUI_FoodOverviewTooltipPanel_C
{
public:
	UUI_FoodOverviewTooltipPanel_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
	...
	struct UUI_TooltipOverviewElement_C GetUI_TooltipOverviewElement_C_8() {
