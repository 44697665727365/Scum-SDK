...
public:
	...
	char EAttachLocation GetLocationType() {
		return memory.read<char EAttachLocation>(m_addr + 48);
	}
	...
	uint8_t  GetPoolingMethod() {
		return memory.read<uint8_t >(m_addr + 51);
	}
...
public:
	...
	uint8_t  GetSpawnSectionStartBehavior() {
		return memory.read<uint8_t >(m_addr + 24);
	}
	uint8_t  GetSpawnSectionEvaluateBehavior() {
		return memory.read<uint8_t >(m_addr + 28);
	}
	uint8_t  GetSpawnSectionEndBehavior() {
...
public:
	...
	char ENiagaraBindingSource GetBindingSourceMode() {
		return memory.read<char ENiagaraBindingSource>(m_addr + 80);
	}
...
public:
	...
	uint8_t  GetActualExecutionState() {
		return memory.read<uint8_t >(m_addr + 32);
	}
	uint8_t  GetRequestedExecutionState() {
		return memory.read<uint8_t >(m_addr + 36);
	}
...
public:
	...
	uint8_t  GetSystemDebugVerbosity() {
		return memory.read<uint8_t >(m_addr + 108);
	}
	uint8_t  GetSystemEmitterVerbosity() {
...
public:
	...
	uint8_t  GetDistributionMode() {
		return memory.read<uint8_t >(m_addr + 0);
	}
	uint8_t  GetLeadingEdgeMode() {
		return memory.read<uint8_t >(m_addr + 4);
	}
	uint8_t  GetTrailingEdgeMode() {
		return memory.read<uint8_t >(m_addr + 8);
	}
...
public:
	...
	uint8_t  GetPoolingMethod() {
		return memory.read<uint8_t >(m_addr + 54);
	}
	bool GetbPreCullCheck() {
