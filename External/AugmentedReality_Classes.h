...
public:
	...
	struct TMap<uint8_t , float> GetBlendShapes() {
		return memory.read<struct TMap<uint8_t , float>>(m_addr + 264);
	}
...
public:
	...
	struct FARPlaneUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARPlaneUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARPointUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARPointUpdatePayload>(m_addr + 632);
	}
...
public:
	...
	bool GetbFaceOutOfScreen() {
		return memory.read<bool>(m_addr + 634);
	}
	struct FARFaceUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARFaceUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARObjectUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARObjectUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARImageUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARImageUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARQRCodeUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARQRCodeUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARPoseUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARPoseUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FAREnvironmentProbeUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FAREnvironmentProbeUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARMeshUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARMeshUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	struct FARGeoAnchorUpdatePayload GetReplicatedPayload() {
		return memory.read<struct FARGeoAnchorUpdatePayload>(m_addr + 640);
	}
...
public:
	...
	uint8_t  GetLightEstimationMode() {
		return memory.read<uint8_t >(m_addr + 64);
	}
	uint8_t  GetFrameSyncMode() {
	...
	uint8_t  GetEnvironmentCaptureProbeType() {
	...
	uint8_t  GetFaceTrackingDirection() {
		return memory.read<uint8_t >(m_addr + 141);
	}
	uint8_t  GetFaceTrackingUpdate() {
		return memory.read<uint8_t >(m_addr + 142);
	}
	...
	uint8_t  GetEnabledSessionTrackingFeature() {
		return memory.read<uint8_t >(m_addr + 168);
	}
	uint8_t  GetSceneReconstructionMethod() {
...
public:
	...
	uint8_t  GetDepthQuality() {
		return memory.read<uint8_t >(m_addr + 408);
	}
	uint8_t  GetDepthAccuracy() {
		return memory.read<uint8_t >(m_addr + 409);
	}
...
public:
	...
	uint8_t  GetObjectClassification() {
		return memory.read<uint8_t >(m_addr + 184);
	}
	uint8_t  GetSpatialMeshUsageFlags() {
		return memory.read<uint8_t >(m_addr + 185);
	}
