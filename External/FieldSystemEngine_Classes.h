...
public:
	...
	bool GetbIsChaosField() {
		return memory.read<bool>(m_addr + 1113);
	}
	struct TArray<struct TSoftObjectPtr<AChaosSolverActor>> GetSupportedSolvers() {
		return memory.read<struct TArray<struct TSoftObjectPtr<AChaosSolverActor>>>(m_addr + 1120);
	}
	struct FFieldObjectCommands GetConstructionCommands() {
		return memory.read<struct FFieldObjectCommands>(m_addr + 1136);
	}
	struct FFieldObjectCommands GetBufferCommands() {
		return memory.read<struct FFieldObjectCommands>(m_addr + 1184);
	}
...
public:
	...
	char EFieldResolutionType GetResolutionType() {
		return memory.read<char EFieldResolutionType>(m_addr + 176);
	}
...
public:
	...
	char EFieldFilterType GetFilterType() {
		return memory.read<char EFieldFilterType>(m_addr + 176);
	}
...
public:
	...
	char ESetMaskConditionType GetSetMaskCondition() {
		return memory.read<char ESetMaskConditionType>(m_addr + 200);
	}
...
public:
	...
	char EWaveFunctionType GetFunction() {
		return memory.read<char EWaveFunctionType>(m_addr + 200);
	}
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 201);
	}
...
public:
	...
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 208);
	}
...
public:
	...
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 220);
	}
...
public:
	...
	char EFieldFalloffType GetFalloff() {
		return memory.read<char EFieldFalloffType>(m_addr + 240);
	}
...
public:
	...
	char EFieldOperationType GetOperation() {
		return memory.read<char EFieldOperationType>(m_addr + 200);
	}
...
public:
	...
	char EFieldCullingOperationType GetOperation() {
		return memory.read<char EFieldCullingOperationType>(m_addr + 192);
	}
