...
public:
	...
	char EComponentMobility GetMobility() {
		return memory.read<char EComponentMobility>(m_addr + 544);
	}
	uint8_t  GetLightType() {
		return memory.read<uint8_t >(m_addr + 545);
	}
	uint8_t  GetLightShape() {
		return memory.read<uint8_t >(m_addr + 546);
	}
...
public:
	...
	uint8_t  GetSearchPackagePolicy() {
		return memory.read<uint8_t >(m_addr + 40);
	}
	uint8_t  GetMaterialConflictPolicy() {
		return memory.read<uint8_t >(m_addr + 41);
	}
	uint8_t  GetTextureConflictPolicy() {
		return memory.read<uint8_t >(m_addr + 42);
	}
	uint8_t  GetStaticMeshActorImportPolicy() {
		return memory.read<uint8_t >(m_addr + 43);
	}
	uint8_t  GetLightImportPolicy() {
		return memory.read<uint8_t >(m_addr + 44);
	}
	uint8_t  GetCameraImportPolicy() {
		return memory.read<uint8_t >(m_addr + 45);
	}
	uint8_t  GetOtherActorImportPolicy() {
		return memory.read<uint8_t >(m_addr + 46);
	}
	uint8_t  GetMaterialQuality() {
		return memory.read<uint8_t >(m_addr + 47);
	}
...
public:
	...
	char EComponentMobility GetMobility() {
		return memory.read<char EComponentMobility>(m_addr + 96);
	}
...
public:
	...
	char ESkyLightSourceType GetSourceType() {
		return memory.read<char ESkyLightSourceType>(m_addr + 48);
	}
