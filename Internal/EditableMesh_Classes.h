...
struct UEditableMeshAdapter : public UObject
{
...
// Size: 0x28(Inherited: 0x28) 
struct UEditableMeshFactory : public UObject
{
...
struct UEditableMesh : public UObject
{
	...
	void TessellatePolygons(struct TArray<struct FPolygonID>& PolygonIDs, uint8_t  TriangleTessellationMode, struct TArray<struct FPolygonID>& OutNewPolygonIDs); // Function EditableMesh.EditableMesh.TessellatePolygons
	void StartModification(uint8_t  MeshModificationType, uint8_t  MeshTopologyChange); // Function EditableMesh.EditableMesh.StartModification
	...
	void InsetPolygons(struct TArray<struct FPolygonID>& PolygonIDs, float InsetFixedDistance, float InsetProgressTowardCenter, uint8_t  mode, struct TArray<struct FPolygonID>& OutNewCenterPolygonIDs, struct TArray<struct FPolygonID>& OutNewSidePolygonIDs); // Function EditableMesh.EditableMesh.InsetPolygons
